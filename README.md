...
### 📅 2026-01-19 (Review)
**학습 주제:** Part 1. 퍼셉트론(Perceptron) 이론 복습 및 발표자료 제작 (1/2)

#### 1. 퍼셉트론의 기초
* **정의:** 인간의 신경세포(Neuron) 구조를 모방하여, 다수의 입력 신호를 받아 하나의 신호를 출력하는 알고리즘.
* **핵심 매개변수:**
  * **가중치($w$):** 입력 신호가 결과에 미치는 영향력(중요도)을 조절.
  * **편향($b$):** 뉴런이 얼마나 쉽게 활성화(1을 출력)되는지를 조절.
* **기본 논리 회로 구현:**
  * 단층 퍼셉트론을 이용해 **AND, NAND, OR 게이트**를 구현할 수 있음.

#### 2. 활동 내역
* 퍼셉트론의 작동 원리와 한계를 시각적으로 설명하는 PPT 자료 제작.
